...
selectInput('week','Week',choices =2:51,selected =2,multiple =F),
...
output_graphs_spat<-tabsetPanel(
...
dat_opts_spat<- tabPanel("Data_Upload",
                         column(12,
                                boxPlus(width=12,
                                        
                                        fileInput('shape_file', 'Spatial boundary file (.shp file)',
                                                  accept=c('.shp','.dbf','.shx','.prj'),
                                                  multiple =T),
                                        fileInput('dat_spat', 'choose file to upload', accept=c('.xls','.xlsx','.csv')),
